...
public class OI {
	public OI() {
		...
		CommandBase.joystick.whenPressed(SubsystemJoystick.d_A, new CommandHatchMotorUp(0.5));
		CommandBase.joystick.whenPressed(SubsystemJoystick.d_B, new CommandHatchMotorUp(-0.3));
		CommandBase.joystick.whenPressed(SubsystemJoystick.d_X, new CommandHatchIntakeSolenoid());
