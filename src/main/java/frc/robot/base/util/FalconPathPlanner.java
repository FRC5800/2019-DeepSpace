 ...
 */
	...
	public static void main(String[] args)
	{
		...
		double totalTime = 11; //seconds
		double timeStep = 0.; //period of control loop on Rio, seconds
		double robotTrackWidth = 2.4; //distance between left and right wheels, feet
